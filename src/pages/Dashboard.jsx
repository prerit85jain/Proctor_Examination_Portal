...
const Dashboard = () => {
  ...
  const [enrolledStudents, setEnrolledStudents] = useState([
    { id: 1, name: 'John Doe', email: 'john@example.com', subjects: ['Mathematics', 'Physics'] },
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', subjects: ['Mathematics', 'Chemistry'] },
    { id: 3, name: 'Mike Johnson', email: 'mike@example.com', subjects: ['Physics', 'Chemistry'] },
  ]);
